...
import com.magalu.desafio.api.domain.repository.ClienteRepository;
...
public class ClienteController {
	...
	public ResponseEntity<Cliente> atualizar(@PathVariable("clienteId") Long clienteId, @Valid @RequestBody Cliente cliente){
